...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/back/vendor/jquery-ui/jquery-ui.min.css'); ?>">
    <script src="<?php echo base_url('assets/back/vendor/jquery.min.js'); ?>"></script>
